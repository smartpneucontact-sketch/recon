const I18N = {
  en: {
    ...
    'users.smsAlertsHint': 'By turning this on, the user consents to receive operational text messages from Atlantic Subaru Recon — only when a job is flagged urgent or marked done. Message and data rates may apply. Frequency varies. Reply STOP to unsubscribe at any time.',
    ...
    'users.whatsappAlertsHint': 'Same urgent / done triggers as SMS, delivered through WhatsApp via Meta\'s Cloud API. The user\'s phone must be on the approved recipient list (or one of the 5 test numbers during setup).',
    ...
    'dashboard.categoriesLabel': 'Categories',
    'dashboard.searchPlaceholder': 'Search by stock number…',
    ...
    'addCar.laneRequired': 'Please choose a bay.',
    ...
    'detail.lane': 'Bay',
    'detail.markUrgent': 'Mark as urgent',
    'detail.unmarkUrgent': 'Clear urgent flag',
    'detail.urgentActive': 'This job is flagged URGENT.',
    'badge.urgent': 'URGENT',
    'toast.urgentTitle': 'URGENT',
    'toast.urgentSub': 'A job has been flagged.',
    'toast.urgentSubBy': 'Flagged by',
    'push.enable': 'Get notified when a job is marked urgent.',
  ...
  es: {
    ...
    'users.smsAlertsHint': 'Al activarlo, el usuario consiente recibir mensajes de texto operativos de Atlantic Subaru Recon — solo cuando un trabajo se marca urgente o terminado. Pueden aplicarse tarifas. La frecuencia varía. Responde STOP para darte de baja.',
    ...
    'users.whatsappAlertsHint': 'Mismos disparadores urgente/terminado que SMS, entregados por WhatsApp a través de la Cloud API de Meta. El teléfono del usuario debe estar en la lista aprobada (o ser uno de los 5 números de prueba durante la configuración).',
    ...
    'dashboard.categoriesLabel': 'Categorías',
    'dashboard.searchPlaceholder': 'Buscar por número de stock…',
    ...
    'addCar.laneRequired': 'Elige una bahía.',
    ...
    'detail.lane': 'Bahía',
    'detail.markUrgent': 'Marcar urgente',
    'detail.unmarkUrgent': 'Quitar urgencia',
    'detail.urgentActive': 'Este trabajo está marcado URGENTE.',
    'badge.urgent': 'URGENTE',
    'toast.urgentTitle': 'URGENTE',
    'toast.urgentSub': 'Un trabajo ha sido marcado.',
    'toast.urgentSubBy': 'Marcado por',
    'push.enable': 'Recibe avisos cuando un trabajo se marque urgente.',
    'push.enableBtn': 'Activar',
